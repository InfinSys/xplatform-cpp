...
# warning policy, optimization strategy, and Clang-specific
# preprocessor symbols. These individual targets, together with the
# global C configuration, are consolidated into a single linkable
# target. This module also enforces a minimum compiler version upfront
# to prevent the use of an unsupported toolchain.
#
...
add_library(${PRJ_PREFIX_L}_clang_c_features INTERFACE)
# Compiler diagnostics configuration target
add_library(${PRJ_PREFIX_L}_clang_c_warnings INTERFACE)
# General compiler configuration target
add_library(${PRJ_PREFIX_L}_clang_c_options INTERFACE)
# Preprocessor definitions target
add_library(${PRJ_PREFIX_L}_clang_c_defines INTERFACE)

# Set C standard version
target_compile_features(
    ${PRJ_PREFIX_L}_clang_c_features
...
target_compile_options(
    ${PRJ_PREFIX_L}_clang_c_warnings
...
add_library(${PRJ_PREFIX_L}_clang_c_bundle INTERFACE)

target_link_libraries(
    ${PRJ_PREFIX_L}_clang_c_bundle
