...
#
# @details
# Assembles the complete g++ compiler configuration bundle by defining
...
add_library(${PRJ_PREFIX_L}_gcc_cxx_features INTERFACE)
# Compiler diagnostics configuration target
add_library(${PRJ_PREFIX_L}_gcc_cxx_warnings INTERFACE)
# General compiler configuration target
add_library(${PRJ_PREFIX_L}_gcc_cxx_options INTERFACE)
# Preprocessor definitions target
add_library(${PRJ_PREFIX_L}_gcc_cxx_defines INTERFACE)

# Set C++ standard version
target_compile_features(
    ${PRJ_PREFIX_L}_gcc_cxx_features
...
target_compile_options(
    ${PRJ_PREFIX_L}_gcc_cxx_warnings
...
add_library(${PRJ_PREFIX_L}_gcc_cxx_bundle INTERFACE)

target_link_libraries(
    ${PRJ_PREFIX_L}_gcc_cxx_bundle
